                            ...
                            <div>
                                {/*Unemployment*/}
                                {
                                    ['2014','2015','2016','2017','2018'].includes(this.state.year) && this.state.chartmeasure === 'Unemployment' ?
                                        ...
                                        :
                                        this.state.year === 'HISPANIC New Yorkers 5 year Estimate(2012-2016)' && this.state.chartmeasure === 'Unemployment' ?
                                            <div style = {{display:'flex',justifyContent:'center',flexDirection:'column', alignItems:'center'}}>
                                ...
                                {/*Poverty*/}
                                {
                                    ['2014','2015','2016','2017','2018'].includes(this.state.year) && this.state.chartmeasure === 'Poverty' ?
                                        ...
                                        :
                                        this.state.year === 'HISPANIC New Yorkers 5 year Estimate(2012-2016)' && this.state.chartmeasure === 'Poverty'?
                                            <div style = {{display:'flex',justifyContent:'center',flexDirection:'column', alignItems:'center'}}>
                                ...
                                {/*Educational Attainment*/}
                                {
                                    ['2014','2015','2016','2017','2018'].includes(this.state.year) && this.state.chartmeasure === 'Educational Attainment' ?
                                        ...
                                        :
                                        this.state.year === 'HISPANIC New Yorkers 5 year Estimate(2012-2016)' && this.state.chartmeasure === "Educational Attainment" ?
                                            <div style = {{display:'flex',justifyContent:'center',flexDirection:'column', alignItems:'center'}}>
                                                <GroupedTripleStackedBarChart
                                ...
                                {/*Demographics*/}
                                {
                                    ['2014','2015','2016','2017','2018'].includes(this.state.year) && this.state.chartmeasure === 'Demographics' ?
                                        ...
                                        :
                                        this.state.year === 'HISPANIC New Yorkers 5 year Estimate(2012-2016)' && this.state.chartmeasure === 'Demographics' ?
                                            <div style = {{display:'flex',justifyContent:'center',flexDirection:'column', alignItems:'center'}}>
                                                <div>
                                                    <BarChart
                                                        type={['Demographics']} year={[this.state.year]}
                                ...
                                {/*English Proficiency*/}
                                {
                                    ['2014','2015','2016','2017','2018'].includes(this.state.year) && this.state.chartmeasure === 'English Proficiency' ?
                                        ...
                                        :
                                        this.state.year === 'HISPANIC New Yorkers 5 year Estimate(2012-2016)' && this.state.chartmeasure === 'English Proficiency' ?
                                            <div style = {{display:'flex',justifyContent:'center',flexDirection:'column', alignItems:'center'}}>
                                                <SimpleStackedBarChart
                                                    type={['Eng_Prof']} year ={[this.state.year]}
